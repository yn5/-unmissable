...
import { StyleSheet, TextInput, Platform, Alert, TouchableOpacity, View } from 'react-native';
...
import type { Reminder, RecurrenceType } from '@/types/reminder';
      ...
      <ThemedView style={styles.form}>
        ...
        {recurrenceType === 'custom' && (
          <View style={styles.customDaysContainer}>
            <TextInput
              style={[styles.customDaysInput, { color: textColor, borderColor: Colors[colorScheme].icon }]}
